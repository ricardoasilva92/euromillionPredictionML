...
namespace EuromillionsML
{
    ...
    {
        static readonly string _trainDataPath = Path.Combine("C:\\Projects\\EuromillionsML\\EuromillionsML", "Data", "drawns.csv");
        static readonly string _testDataPath = Path.Combine("C:\\Projects\\EuromillionsML\\EuromillionsML", "Data", "drawns_test.csv");
        static readonly string _modelPath = Path.Combine("C:\\Projects\\EuromillionsML\\EuromillionsML", "Data", "Model.zip");
        ...
        {
            IDataView dataView = mlContext.Data.LoadFromTextFile<EuroDrawnData>(_testDataPath, hasHeader: true, separatorChar: ',');
