...
{
    //https://docs.microsoft.com/en-us/dotnet/api/microsoft.ml.trainers.fasttree.fasttreetweedietrainer?view=ml-dotnet
    public static class FastTreeTweedie
    {
        ...
        private static void TestSinglePrediction(MLContext mlContext, ITransformer model)
        {
            ...
            Console.WriteLine($"****************FastTreeTweedie Prediction****************");
