...
{
    //https://docs.microsoft.com/en-us/dotnet/api/microsoft.ml.trainers.lbfgspoissonregressiontrainer?view=ml-dotnet
    public static class LbfgsPoisson
    {
        ...
        private static void TestSinglePrediction(MLContext mlContext, ITransformer model)
        {
            ...
            Console.WriteLine($"****************LbfgsPoisson Prediction****************");
